...
<%@ include file="exp/header.jsp"%>
		...
		<div id="toolbar" style="display:none;">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit-t" plain="true" onclick="editUser()">修改</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove-t" plain="true" onclick="delUser()">删除</a>
		...
		<div id="dlg" class="easyui-dialog" title="用户信息" style="display:none;width:500px;height:500px;" data-options="closed:true,iconCls:'ico i-edit',resizable:true,modal:true,buttons:[{
